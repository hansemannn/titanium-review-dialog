...
#include "ti.reviewdialog.TitaniumReviewDialogModule.h"
...
#define TAG "TitaniumReviewDialogModule"
...
Persistent<FunctionTemplate> TitaniumReviewDialogModule::proxyTemplate;
Persistent<Object> TitaniumReviewDialogModule::moduleInstance;
jclass TitaniumReviewDialogModule::javaClass = NULL;

TitaniumReviewDialogModule::TitaniumReviewDialogModule() : titanium::Proxy()
{
}

void TitaniumReviewDialogModule::bindProxy(Local<Object> exports, Local<Context> context)
{
	...
	Local<String> nameSymbol = NEW_SYMBOL(isolate, "TitaniumReviewDialog"); // use symbol over string for efficiency
...
void TitaniumReviewDialogModule::dispose(Isolate* isolate)
{
	LOGD(TAG, "dispose()");
...
Local<FunctionTemplate> TitaniumReviewDialogModule::getProxyTemplate(v8::Isolate* isolate)
{
	...
	LOGD(TAG, "TitaniumReviewDialogModule::getProxyTemplate()");

	javaClass = titanium::JNIUtil::findClass("ti/reviewdialog/TitaniumReviewDialogModule");
	EscapableHandleScope scope(isolate);

	// use symbol over string for efficiency
	Local<String> nameSymbol = NEW_SYMBOL(isolate, "TitaniumReviewDialog");
...
Local<FunctionTemplate> TitaniumReviewDialogModule::getProxyTemplate(v8::Local<v8::Context> context)
{
...
void TitaniumReviewDialogModule::isSupported(const FunctionCallbackInfo<Value>& args)
{
	...
	if (!methodID) {
		methodID = env->GetMethodID(TitaniumReviewDialogModule::javaClass, "isSupported", "()Z");
		if (!methodID) {
